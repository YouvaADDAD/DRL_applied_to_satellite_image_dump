...
class DQNAgent_Experimentation():
    ...
    def fitModel(self):
        ...
        self.dqn.fit(self.env, nb_steps=30000, visualize=False, verbose=1,log_interval=1000)
        self.dqn.save_weights('dqn_weights{}_{}.h5f'.format(self.env.numbersatellites, self.env.numberstations),
                              overwrite=True)
